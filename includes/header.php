...
<body>
	...
	<div class="heading"><center><h1>Games Management System</h1></center></div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-center">        
        ...
        <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-btc"></i>  Brand(Make)</a></li>        

        <li id="navCategories"><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> Category</a></li>        

        <li id="navProduct"><a href="product.php"> <i class="glyphicon glyphicon-ruble"></i> Products(Items) </a></li>     
